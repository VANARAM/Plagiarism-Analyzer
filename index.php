...
<head>
	<title>Plagiarism Analyzer</title>
			...
			<header>
				...
				<div class="header-bottom-w3layouts">
					<div class="main-w3ls-logo">
						<h1><a href="index.php"><span class="fa fa-check-square-o" aria-hidden="true"></span>PLAGIARISM ANALYZER</a></h1>
					</div>
					<!-- navigation -->
	...
	<div class="footer-agileits-w3layouts">
		<div class="container">
			<div class="btm-logo-w3ls">
				<h2><a href="index.html"><span class="fa fa-check-square-o" aria-hidden="true"></span>Plagiarism</a></h2>
			</div>
			<div class="clearfix"> </div>
		</div>
	</div>
