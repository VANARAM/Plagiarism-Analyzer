...
{
    $email_error = "Email should not contain special characters";
}
if(!preg_match("/^\d{10}$/",$mobnum))
{
    $mobnum_error = "Mobile number must be number of 10 digits";
}
if(isset($fname_error) or isset($lname_error) or isset($email_error) or isset($mobnum_error))
echo " ";
$cid=$_POST['cid'];
                                ...
                                <div class="col-md-3">
                                    <div class="basic-form">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control border-none input-flat bg-ash" name="lname">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-12">
                                    <div class="basic-form">
                                        <div class="form-group image-type">
                                            <label>Upload Teacher Photo(Only jpg / jpeg/ png /gif format allowed) <span>(150 X 150)</span></label>
