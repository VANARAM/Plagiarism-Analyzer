        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a class="sidebar-sub-toggle"><i class="ti-user"></i> Check Plagiarism <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                            <li><a href="upload4.php">Check Plagiarism</a></li>
                        </ul>
                       <!-- echo shell_exec("C:\xampp\htdocs\Oline College Assignment System Project\ocas\teacher\pythom\similarity.py") -->
